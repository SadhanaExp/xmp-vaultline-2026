...
function seedInbox(): HandoffLead[] {
  return [
    ...
    { id: "enc-summit", source_crm: "Encompass", company: "Summit Savings Bank", quote_amount: "$44,000 / year", quote_version: "v2", status: "queued", why_qualified: "Encompass deal won. Lending committee approved the Experience.com rollout.", gaps: ["Billing / AP contact missing", "Order form not attached in CRM"], contacts: [{ name: "Grace Whitfield", role: "SVP Retail Lending", is_signer: true, email: "grace@summitsavings.example" }, { name: "Peter Osei", role: "Risk", is_signer: false, email: "peter@summitsavings.example" }] },
  ];
}
